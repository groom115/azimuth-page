            ...
            <div className="flex flex-row justify-between items-center">
                <div className="flex flex-row gap-4">
                    ...
                    <div className="flex flex-col text-left justify-between gap-y-1.5">
                        ...
                        {windowWidth > 600 && (<p className="text-white text-sm">Your <span style={{ color: "#6979F8" }}>Data-Driven Path</span> to Unforgettable Show</p>)}
                    </div>
                    ...
                    >
                        <div className="flex items-center">
                            ...
                            <input
                                ...
                                className=" pl-10 pr-3 block w-full rounded-xl  border-1 py-1 sm:py-1.5 shadow-sm ring-2 ring-inset ring-blue-600 focus:none text-sm leading-6 text-white"
                            />
